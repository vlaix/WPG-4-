...
public class Traptest : MonoBehaviour
{
    ...
    public int ActiveTrapCount => activeTraps.Count; public void OnPlaceTrap(InputAction.CallbackContext context)
    {
        // Gunakan performed agar hanya terpanggil satu kali saat tombol ditekan
